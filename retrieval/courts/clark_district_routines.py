"""
Clark District Court Retrieval Routines
v0.3.0

Implements source-specific routines for the Clark County District Court
...
CLARK_DISTRICT_ROUTINES_VERSION = "0.3.0"
...
class ClarkDistrictRoutines:
    """
    Retrieval routines for Clark County District Court (Odyssey Portal).
    """

    BASE_URL = "https://odyssey.clarkcountycourts.us/CaseSearch"
        ...
        for page in range(1, max_pages + 1):
            ...
            for row in rows[1:]:
                ...
                if not detail_url.startswith("http"):
                    detail_url = "https://odyssey.clarkcountycourts.us" + detail_url
